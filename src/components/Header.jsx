    ...
    >
      <div className="flex justify-between items-center w-10/12 mx-auto">
        <Link to="home" smooth={true} duration={500}>
          <img src={logo} alt="Entelika Logo" className="h-10 cursor-pointer" />
        </Link>
      ...
      >
        ...
        <div className="flex flex-col justify-around h-full p-4">
          ...
          <div className="flex justify-center space-x-4 mt-10">
            ...
            >
              <img src={facebook_logo} alt="Facebook" className="h-6 w-6" />
            </a>
            <a
              ...
              rel="noopener noreferrer"
            >
              <img src={twitter_logo} alt="Twitter" className="h-6 w-6" />
            </a>
            <a
              ...
              rel="noopener noreferrer"
            >
              <img src={linkedin_logo} alt="LinkedIn" className="h-6 w-6" />
            </a>
            <a
              ...
              rel="noopener noreferrer"
            >
              <img src={instagram_logo} alt="Instagram" className="h-6 w-6" />
            </a>
          </div>
        </div>
      </div>
