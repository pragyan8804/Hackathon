    ...
    <div id="partners" className="bg-gray-100 py-16">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-12">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 text-center transition-transform transform hover:-translate-y-1 hover:shadow-2xl w-64 h-80">
          ...
          >
            <img src={NieLogo} alt="NIE Logo" className="h-32 mx-auto" />
          </a>
          <p className="text-gray-500 text-sm mt-3">
            The National Institute of Engineering
          </p>
          <p className="text-gray-500 text-sm">(Department of IS&E)</p>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 text-center transition-transform transform hover:-translate-y-1 hover:shadow-2xl w-64 h-80">
          <a
            ...
            className="block mb-6"
          >
            <img src={IeiLogo} alt="IEI Logo" className="h-32 mx-auto" />
          </a>
          <p className="text-gray-500 text-sm mt-3">
          ...
          <p className="text-gray-500 text-sm">(Mysore Local Center)</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 text-center transition-transform transform hover:-translate-y-1 hover:shadow-2xl w-64 h-80">
          <a
            ...
            className="block mb-6"
          >
            <img src={CsiLogo} alt="CSI Logo" className="h-32 mx-auto" />
          </a>
          <p className="text-gray-500 text-sm mt-3">
