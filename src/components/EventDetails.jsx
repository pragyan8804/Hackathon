                    ...
                    <table className="table-auto w-full text-left text-sm lg:text-base">
                        ...
                        <tbody>
                            ...
                            <tr className="bg-gray-50">
                                ...
                                <td className="border px-4 py-2">
                                    Mr. Leandro Ferreira Heroso (Houston, US)
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="border px-4 py-2">
                                    ...
                                    details must be submitted by this timeframe
                                </td>
                            </tr>
                            <tr className="bg-gray-50">
                                <td className="border px-4 py-2">
                                    First round of selection by college (3 teams
                                    per college)
                                </td>
                                <td className="border px-4 py-2">
                                ...
                                <td className="border px-4 py-2">
                                    Colleges to identify and send top 3 teams to
                                    main event
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td className="border px-4 py-2">
                                    Final evaluation by NIE Professors and Chief
                                    Guest present online (Mr. Leandro Ferreira
                                    Heroso), Selected Faculty Members from other
                                    colleges and Entelika Representatives
                                </td>
                            </tr>
                        </tbody>
                    </table>
