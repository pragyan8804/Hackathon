  ...
  return (
    ...
    >
      <div className="w-full text-center flex flex-col mb-10">
        <h2 className="text-5xl font-bold mb-5">Workforce Value Stream</h2>
        <p className="text-2xl">Smart Internship Recommendation Engine</p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-6 mb-12">
        ...
        <div className="w-full lg:w-1/2 text-left">
          <p className="text-lg mb-6">
            "Workforce Value Stream" is aimed to revolutionize the internship
            search process for students. Participants are expected to build a
            smart internship recommendation engine utilizing advanced algorithms
            and machine learning techniques to provide personalized internship
            recommendations tailored to each student's unique profile and
            preferences by analyzing factors such as skills, location, salary
          ...
          <ul className="list-disc list-inside">
            <li className="mb-2">
              <strong className="text-lg">
                Topic 1: "Personalized Internship Recommendations"
              </strong>
              <p>
                Objective: Develop a recommendation engine that provides
                personalized internship recommendations based on each student's
                unique profile, including skills, location, salary expectations,
                and industry interests. Utilize advanced algorithms and machine
                learning techniques to analyze and match students with
            ...
            <li className="mb-2">
              ...
              <p>
                Objective: Develop a recommendation engine that matches students
                with internship opportunities based on the skills listed in
                their resumes. Utilize natural language processing (NLP)
                techniques to extract skills from resumes and match them with
                internship requirements. Explore methods for skill assessment,
                matching, and recommendation to enhance internship relevance and
                fit.
              </p>
            </li>
            <li className="mb-2">
              <strong className="text-lg">
                Topic 3: "Job Portal Parsing for Skill-Centric Job
                Recommendations"
              </strong>
              <p>
                Objective: Develop approaches for parsing through any career
                portal and recommending jobs based on user-provided skills.
                Utilize natural language processing (NLP) techniques to extract
                skills from user inputs and match them with job requirements.
                Explore algorithms and methodologies to enhance the relevance
                and fit of job recommendations based on user-provided skills.
              </p>
            </li>
          </ul>
        </div>
      ...
      <table className="table-auto w-full text-left text-black">
        ...
        <tbody>
          ...
          <tr className="font-bold">
            <td className="border px-4 py-2 bg-gray-300">Total Points</td>
            <td className="border px-4 py-2 bg-gray-300">{points}</td>
          </tr>
        </tbody>
      </table>
    </div>
